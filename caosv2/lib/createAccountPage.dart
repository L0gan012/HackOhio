      ...
      body: Flex(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: FlatButton(
              onPressed: () {
                if (_read('firstNameChange') == 0 ||
                    _read('firstNameChange') == "") {
                  Scaffold.of(context).showSnackBar(SnackBar(
                    content: Text('Please enter your first name'),
                  ));
                } else if (_read('lastNameChange') == 0 ||
                    _read('lastNameChange') == "") {
                  Scaffold.of(context).showSnackBar(SnackBar(
                    content: Text('Please enter your last name'),
                  ));
                } else if (_read('ageChange') == 0 ||
                    _read('ageChange') == "") {
                  Scaffold.of(context).showSnackBar(SnackBar(
                    content: Text('Please enter your age'),
                  ));
                } else if (_read('emailChange') == 0 ||
                    _read('emailChange') == "") {
                  Scaffold.of(context).showSnackBar(SnackBar(
                    content: Text('Please enter your email'),
                  ));
                } else if (_read('passwordChange') == 0 ||
                    _read('passwordChange') == "") {
                  Scaffold.of(context).showSnackBar(SnackBar(
